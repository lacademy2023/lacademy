...
<h1>LITSURE ACADEMY</h1>
  ...
  <div class="feature-box">
    <a href="https://youtu.be/Sa9r7qyLe4I">
      <div class="course-card">
        <h3>SET GENERAL PAPER POSSIBLE QUESTIONS PART-1</h3>
        <p>Enroll now and enhance your English skills for SET Paper 1.</p>
      </div>
    </a>
  </div>

  <div class="feature-box">
    <a href="https://youtu.be/rwOAgG-Gpc8">
      <div class="course-card">
        <h3>SET GENERAL PAPER POSSIBLE QUESTIONS PART-2</h3>
  ...
  <div class="feature-box">
    <a href="https://youtu.be/s4oh5EJ7wc8">
      <div class="course-card">
        <h3>SET GENERAL PAPER POSSIBLE QUESTIONS PART-3</h3>
        <p>Join our coaching to excel in SET General Paper 1.</p>
      </div>
    </a>
  </div>
  ...
  <div class="feature-box">
    <a href="https://youtu.be/zAnpPBk3ulI">
      <div class="course-card">
        <h3>SET GENERAL POSSIBLE PAPER RQUESTIONS PART-4</h3>
        <p>Join our coaching to excel in SET General Paper 1.</p>
      </div>
    </a>
  </div>
 ...
 <div class="feature-box">
    ...
    <a href="https://youtu.be/lV74KXI6GRA">
      <div class="course-card">
        <h3>SET GENERAL POSSIBLE PAPER QUESTIONS PART-5</h3>
        <p>Join our coaching to excel in SET General Paper 1.</p>
      </div>
    </a>
  </div>
